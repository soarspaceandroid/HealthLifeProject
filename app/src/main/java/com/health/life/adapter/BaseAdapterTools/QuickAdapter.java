 ...
 */
package com.health.life.adapter.BaseAdapterTools;
		...
		BaseQuickAdapter<T, BaseAdapterHelper>
{
			...
			View convertView, ViewGroup parent)
	{
		...
		{
			return com.health.life.adapter.BaseAdapterTools.BaseAdapterHelper.get(
					context,
					convertView,
					parent,
		...
		{
			return com.health.life.adapter.BaseAdapterTools.BaseAdapterHelper.get(context, convertView, parent, layoutResId, position);
		}
	}
